...
import {
  ...
  Alert,
  ImageComponent,
} from "react-native"; // Core React Native components for layout and styling
    ...
    <SafeAreaView className="bg-primary h-full">
      ...
      <ScrollView>
        <View className="w-full justify-center min-h-[83vh] px-4 my-6">
          ...
          <FormField
            title="אימייל" // Label for the input field
          ...
          <FormField
            title="סיסמה" // Label for the input field
