...
export default function StudentPendings() {
  const { fetchStudentReview, pendingStudentReviews, submitStudentReview } =
    useLesson(); // Add fetchMentorReviwes
  ...
  const handleSubmitReview = async (reviewData) => {
    console.log(
      "📝 StudentPendings: Submitting review for lesson:",
      selectedLesson?.id
    );
    if (selectedLesson) {
